...
//    ax25_init(&hax25, (uint8_t *) "CubeSatSim", '2', (uint8_t *) CALLSIGN, '2',
	...
	char header_str2[] = "rm t.txt && echo 'KU2Y>CQ:hi' >  t.txt && echo 'KU2Y>CQ:hi hi ";
	char footer_str[] = "\' >> t.txt && echo \'KU2Y>CQ:hi hi ' && gen_packets -o telem.wav t.txt && cat telem.wav | csdr convert_i16_f | csdr gain_ff 7000 | csdr convert_f_samplerf 20833 | sudo /home/pi/CubeSatSim/rpitx/rpitx -i- -m RF -f 434.9e3 &>/dev/null";
