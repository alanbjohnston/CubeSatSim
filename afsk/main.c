...
//    zAngularVelocity = (-0.69)*(gyroZ)*(gyroZ) + 45.3 * (gyroZ) + 2078;
  ...
  encodeA(b, 51 + head_offset, 1 + 2048); // STEMBoardFailure + NormalModeFailure);  // NormalModeFailure set to 32 if in Safe Mode
  encodeB(b, 52 + head_offset, 1 + 2048); // 16+32+64); // Try TXAntenna RXAntenna 
