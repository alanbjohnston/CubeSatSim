...
axis[0] = 0; // rnd_float(-0.2, 0.2);
axis[1] = 0; // rnd_float(-0.2, 0.2);
axis[2] = (rnd_float(-0.2, 0.2) > 0) ? 1.0: -1.0;

angle[0] = (axis[2] != 0) ? (float) atan(axis[1] / axis[2]) : 3.14/2.0;
angle[1] = (axis[0] != 0) ? (float) atan(axis[2] / axis[0]) : 3.14/2.0;
angle[2] = (axis[0] != 0) ? (float) atan(axis[1] / axis[0]) : 3.14/2.0;
