...
#        print("There are arguments!")
	    ...
	    while True:
            ...
            print("SSTV")
	    os.system("(while true; do (sleep 5 && cat /home/pi/sstv/sstv.wav | csdr convert_i16_f | csdr gain_ff 7000 | csdr convert_f_samplerf 20833 | sudo rpitx -i- -m RF -f 434.9e3); done)")
