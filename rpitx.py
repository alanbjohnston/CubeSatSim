...
#				sleep(0.1)
			...
			while True:
				try:
					...
					if (debug_mode == 1):
						print("Packet ready!")
					system("gen_packets -a 50 -o /home/pi/CubeSatSim/telem.wav /home/pi/CubeSatSim/t.txt -r 48000")
...
#							output(pd, 0)							
							...
							if (debug_mode == 1):
								...
								system("gen_packets -a 50 -o /home/pi/CubeSatSim/telem.wav /home/pi/CubeSatSim/t.txt -r 48000 && cat /home/pi/CubeSatSim/telem.wav | csdr convert_i16_f | csdr gain_ff 7000 | csdr convert_f_samplerf 20833 | sudo /home/pi/rpitx/rpitx -i- -m RF -f " + tx + "e3 > /dev/null 2>&1")
