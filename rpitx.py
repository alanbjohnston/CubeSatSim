...
#			output (ptt, 0)
#			sleep(0.1)
#			system("aplay -D plughw:CARD=Device,DEV=0 /home/pi/CubeSatSim/morse.wav")
#			sleep(0.1)
#			output (ptt, 1)
#			output(pd, 0)
#		else:	
...
#							output(pd, 1)
							...
							system("aplay -D plughw:CARD=Device,DEV=0 /home/pi/CubeSatSim/telem.wav")							
...
#							output(pd, 1)
							output (ptt, 0)
							system("aplay -D plughw:CARD=Device,DEV=0 /home/pi/CubeSatSim/sstv_image_2_320_x_256.jpg.wav")
							output (ptt, 1)
#							output(pd, 0)
						else:	
							if (debug_mode == 1):
...
#							output(pd, 1)
							output (ptt, 0)
							system("aplay -D plughw:CARD=Device,DEV=0 /home/pi/CubeSatSim/camera_out.jpg.wav")	
							output(ptt, 1)
#							output (pd, 0)
						else:	
							if (debug_mode == 1):
...
#							output(pd, 1)
							output (ptt, 0)
							system("aplay -D plughw:CARD=Device,DEV=0 /home/pi/CubeSatSim/sstv_image_1_320_x_256.jpg.wav")
							output(ptt, 1)
#							output (pd, 0)
						else:	
							if (debug_mode == 1):
...
#								output(pd, 1)
								output (ptt, 0)		
								system("aplay -D plughw:CARD=Device,DEV=0 /home/pi/CubeSatSim/sstv.wav")
								output(ptt, 1)
#								output (pd, 0)		
							else:
								sleep(60)
