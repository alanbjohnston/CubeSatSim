...
if [[ $(arecord -l | grep card) ]] && [ -f "$FILE" ]; then
	...
	if [ "$1" = "d" ]; then
		...
		direwolf -c /home/pi/CubeSatSim/direwolf-cc.conf -t 0l -D 4 | python3 /home/pi/CubeSatSim/dtmf_aprs_cc.py d
	
	else
	
		direwolf -c /home/pi/CubeSatSim/direwolf-cc.conf -t 0l -D 4 | python3 /home/pi/CubeSatSim/dtmf_aprs_cc.py
