...
if [[ $(arecord -l | grep "USB Audio Device") ]] && [ -f "$FILE" ]; then
	...
	if [ "$debug" = "1" ]; then
		...
		direwolf -r 48000 -c /home/pi/CubeSatSim/direwolf-cc.conf -t 0l | python3 /home/pi/CubeSatSim/dtmf_aprs_cc.py d
	
	else
	
		direwolf -r 48000 -c /home/pi/CubeSatSim/direwolf-cc.conf -t 0l | python3 /home/pi/CubeSatSim/dtmf_aprs_cc.py
