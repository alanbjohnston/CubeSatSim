...
//	printf("\nSYMPBLOCK = %d\n", SYMPBLOCK);
	...
	source_bytes[10] = 0xff & ((voltage[map[BAT]] * 1000) >> 8);
	source_bytes[11] = 0xff & (voltage[map[BAT]] * 1000);
	source_bytes[10] = 0xff & ((current[map[BAT]] * 1000) >> 8);
	source_bytes[11] = 0xff & (current[map[BAT]] * 1000);
