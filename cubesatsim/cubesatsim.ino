...
#else
     mySerial.println("AT+DMOSETGROUP=0,434.9000,435.0000,0,1,0,0\r");   // squelch set to 1
#endif	  
...
*/	
	  ...
	  start_clockgen();
	  if (mode == BPSK)
		  clockgen.setClockBPSK(0);
	      else
		      clockgen.setClockFSK(0);
